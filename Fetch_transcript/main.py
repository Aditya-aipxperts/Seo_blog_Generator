...
# def get_video_ids(state: Dict) -> Dict:
...
def get_transcript_with_backoff(state: Dict,max_retries=6) -> Dict:
...
# # --- Add helpers for video URL detection and extraction ---
# def is_video_url(url):
#     """Return True if the URL is a YouTube video URL."""
#     return (
#         re.search(r"youtu\.be/([0-9A-Za-z_-]{11})", url) or
#         re.search(r"youtube\.com/watch\?v=([0-9A-Za-z_-]{11})", url)
#     )
...
#     user_url = input("Enter the YouTube video URL: ").strip()
#     try:
#         if not is_video_url(user_url):
